    ...
    <tbody>
        <tr style="">
            ...
            <td align="center" style="font-weight:bold; font-size: 12px; font-family: Arial, Helvetica, sans-serif;">
                KARTU UJIAN PPDB ({{$role->name}})<br> YAYASAN PENDIDIKAN ISLAM AL FIDAA
                CENDIKIA
            </td>
        </tr>
    </tbody>
...
<table class="tableizer-table" width="17cm"
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>Tanggal</td>
            <td>:</td>
            <td>{{ date('d - m - Y', strtotime($gelombang->tgl_ujian)) }}</td>
        </tr>
        <tr>
            <td>Nama Siswa</td>
            <td class="white-space: nowrap;">:</td>
        ...
        <tr>
            <td colspan="6">2. Pada saat tes membawa <b>Pas Foto</b> ukuran 3x4 satu lembar.</td>
        </tr>
        <tr>
            <td colspan="6">3. Harap Membawa Fotokopi Berkas Pendukung (KK, Akte Kelahiran, Ijazah, SKHUN, raport </td>
        </tr>
        <tr>
            <td colspan="6"> kelas @if($user->role_id === 1) 4,5,6 SD
                @else 7,8,9 SMP @endif masing-masing 1 lembar) pada saat mengikuti tes.</td>
        </tr>
    </tbody>
</table>