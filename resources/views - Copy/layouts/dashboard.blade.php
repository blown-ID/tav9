    ...
    <div class="wrapper">
        ...
        <footer class="main-footer">
            <div class="float-right d-none d-sm-inline">
                <p>Made With <i class="fas text-danger fa-heart"></i> For My Final Exam.</p>
            </div>
            <strong>Copyright &copy; {{ date('Y') }} <a href="https://github.com/fahmiauliarahman"
                    target="_blank">rev3rsed</a>.</strong> All rights
            reserved.
        </footer>
    </div>
