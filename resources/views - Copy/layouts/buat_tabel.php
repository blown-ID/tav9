...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="index3.html" class="brand-link">
                <img src="{{ asset('assets/images/alfidaa.png') }}" alt="Alfidaa Cendikia Logo" class="brand-image img-circle elevation-3">
                <span class="brand-text font-weight-light">Al Fidaa</span>
            </a>
    ...
    <script src="{{ asset('assets') }}/themes/plugins/plugins/datatables-responsive/js/responsive.bootstrap4.min.js">
    </script>
