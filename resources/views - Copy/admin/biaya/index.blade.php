            ...
            <tr>
                ...
                <td colspan="2">
                    <input type="number" name="formulir" id="formulir" class="form-control"
                        value="{{ old('formulir') ?? $item->formulir }}" placeholder="Masukkan Biaya Formulir...">
                </td>
            </tr>
            <tr>
                <td>2</td>
                ...
                <td colspan="2">
                    <input type="number" name="sarana" id="sarana" class="form-control"
                        value="{{ old('sarana') ?? $item->sarana}}" placeholder="Masukkan Biaya Sarana...">
                </td>
            </tr>
            <tr>
                <td>3</td>
                <td>SPP/Bulan</td>
                <td colspan="2">
                    <input type="number" name="spp" id="spp" class="form-control" value="{{ old('spp') ?? $item->spp}}"
            ...
            <tr>
                ...
                <td colspan="2">
                    <input type="number" name="pomg" id="pomg" class="form-control"
                        value="{{ old('pomg') ?? $item->pomg}}" placeholder="Masukkan Biaya POMG..."></td>
            </tr>
            <tr>
                <td>5</td>
                <td>Buku/Tahun</td>
                <td colspan="2">
                    <input type="number" name="buku" id="buku" class="form-control"
                        value="{{ old('buku') ?? $item->buku}}" placeholder="Masukkan Biaya Buku..."></td>
            </tr>
            <tr>
                <td>6</td>
                <td>Seragam</td>
            ...
            <tr>
                ...
                <td colspan="2">
                    <input type="number" name="kesehatan" id="kesehatan" class="form-control"
                        value="{{ old('kesehatan') ?? $item->kesehatan}}" placeholder="Masukkan Biaya Kesehatan...">
                </td>
            </tr>
            <tr>
                <td>8</td>
                ...
                <td colspan="2">
                    <input type="number" name="program" id="program" class="form-control"
                        value="{{ old('program') ?? $item->program}}" placeholder="Masukkan Biaya Program Tahunan...">
                </td>
            </tr>
        </tbody>
    </table>
