...
<body>
                ...
                <ul class="navbar-nav navbar-nav-right">
                    ...
                    <li class="nav-item nav-profile dropdown">
                        ...
                        <div class="dropdown-menu navbar-dropdown" aria-labelledby="profileDropdown">
                            ...
                            <a class="dropdown-item text-primary" href="{{ route('logout') }}" data-toggle="modal"
            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <ul class="nav">
                    ...
                    <li class="nav-item @if ($judul === 'Manajemen Siswa SMP') active @endif">
                        <a class="nav-link" href="{{ route('mgtSMP.index') }}">
                ...
                <footer class="footer">
                    <div class="d-sm-flex justify-content-center justify-content-sm-between">
                        <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright
                            ©{{date('Y')}}. All rights reserved by <a href="https://www.github.com/fahmiauliarahman"
                                target="_blank">rev3rsed</a>.</span>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <form action="{{ route('logout') }}" method="post">
                                    @csrf
                                    <button type="submit" class="btn bg-purple">Keluar</button>
                                </form>
                            </div>
                        </div>
                    </div>
    ...
    <script src="{{ asset('assets') }}/js/dt4.js"></script>
    <script src="{{ asset('assets') }}/js/dt41.js"></script>
