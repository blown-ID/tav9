...
<a href="{{ route('biodata.create') }}" class="btn bg-purple mb-4">Lengkapi Data Siswa</a>
<a href="{{ route('avatar') }}" class="btn bg-purple mb-4">Upload Pas Foto 4x6</a>
@endif
@php
                ...
                <tr>
                    ...
                    <td>
                        <img class="img-thumbnail" style="height: 75px; width: 75px;"
                            src="{{ asset('assets') }}/images/profile/{{ Auth::user()->photo }}">
                    </td>
                </tr>
                @hasanyrole('SMA|SMK')
                <tr>
