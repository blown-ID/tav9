...
if ($siswa) {
$temp_jurusan = $siswa->jurusan;
} else {
$temp_jurusan = '';
}

@endphp
<p>Harap Lengkapi Data Ananda Dibawah Ini Dengan Sebenar-benarnya dan Klik Simpan.</p>
<div class="row mt-3">
    <div class="col-lg">
        <form action="{{ route('biodata.store') }}" method="post">
            ...
            <table class="table table-bordered">
                <tbody>
                    ...
                    <tr>
                        <td>
                            ...
                            <i class="fa fa-question-circle" data-toggle="tooltip" data-placement="right"
                                title="Silahkan Pilih Jurusan Yang Diminati"></j>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td>Asal Sekolah (@role('SMP') SD @endrole @hasanyrole('SMA|SMK') SMP @endrole)</td>
                        <td>
