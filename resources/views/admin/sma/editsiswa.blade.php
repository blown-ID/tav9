...
<div class="row mt-3">
    <div class="col-lg">
        <form action="{{ route('mgtSMA.update', ['mgtSMA'=>$idx]) }}" method="POST">
            @csrf
            @method('patch')
            <table class="table table-bordered">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="jurusan" id="jurusan"
                                ...
                                @if ($siswa)
                                <option value="{{ $item->nama_jurusan }}" @if($item->nama_jurusan === $siswa->jurusan)
                                    selected @endif>
                                    {{ $item->nama_jurusan }}
                                </option>
                                @else
                    ...
                    <tr>
                        <td>Asal Sekolah (@if($user->role_id === 1) SD @else SMA @endif)</td>
                        <td>
