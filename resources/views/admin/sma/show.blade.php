...
<div class="container">
    <div class="col-12 text-center my-3">
        <a href="{{ route('mgtSMA.edit', ['mgtSMA'=>$user->id_user]) }}" class="btn bg-purple m-2">Edit Biodata Calon
            Siswa</a>
        <a href="{{ route('mgtSMA.editparents', ['id'=>$user->id_user]) }}" class="btn bg-purple m-2">Edit Data Orangtua
            Calon Siswa</a>
        <a href="#" class="btn bg-purple m-2" data-toggle="modal" data-target="#gantipassword">Ganti Password Calon
            Siswa</a>
        <form action="{{ route('mgtSMA.printkartu', ['id'=>$user->id_user]) }}" class="d-inline" method="post">
            @csrf
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('mgtSMA.updatenilai', ['id'=>$user->id_user]) }}" method="POST">
                    @csrf
...
<div class="modal fade" id="gantipassword" tabindex="-1" role="dialog" aria-labelledby="gantipasswordLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('mgtSMA.updatepassword', ['id'=>$user->id_user]) }}" method="POST">
                <div class="modal-body">
                    <div class="form-group">
                        @csrf
