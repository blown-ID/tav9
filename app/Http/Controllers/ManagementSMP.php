...
class ManagementSMP extends Controller
{
    public function index()
    {
        $judul = "Manajemen Siswa SMP";
        $users = DB::table('users')
            ...
            ->get();
        // dd($users);
        return view('admin/smp/index', compact('users', 'judul'));
    }
    ...
    public function destroy($id)
    {
        ...
        $user->delete();
        return redirect(route('mgtSMP.index'))->with('success', 'Data Siswa Sudah Berhasil Dihapus!');
    }
    ...
    public function show($id)
    {
        ...
        return view('admin/smp/show', compact('user', 'judul', 'siswa', 'ortu', 'nilai'));
    }
    ...
    public function edit($id)
    {
        ...
        if ($user->role_id !== 1) { //validasi hanya role smp yg bisa diedit disini
            return redirect()->back()->with('errors', '403 Forbidden');
        }
        // end validasi
        $siswa = Detail_Siswa::where('id_siswa', $id)->first();
        ...
        $judul = "Manajemen Siswa SMP";
        return view('admin/smp/editsiswa', compact('user', 'judul', 'siswa', 'jurusan'));
    }
    ...
    public function editparents($id)
    {
        ...
        $judul = "Manajemen Siswa SMP";
        return view('admin/smp/editortu', compact('user', 'judul', 'orangtua'));
    }
    ...
    public function updateparents(Request $request, $id)
    {
        ...
        if ($orangtua) {
            ...
            return redirect(route('mgtSMP.show', $id))->with('success', 'Data Orangtua Sudah Berhasil Diperbarui!');
        } else {
            ...
            $siswa->id_ortu = $id;
            $siswa->save();
            return redirect(route('mgtSMP.show', $id))->with('success', 'Data Orangtua Sudah Berhasil Disimpan!');
        }
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($cekSiswa) {
            ...
            return redirect(route('mgtSMP.show', $tempUser))->with('success', 'Data Sudah Berhasil Diperbarui!');
        } else {
            ...
            return redirect(route('mgtSMP.show', $tempUser))->with('success', 'Data Sudah Berhasil Disimpan!');
    ...
    public function updatepassword(Request $request, $id)
    {
        ...
        $user->save();
        return redirect(route('mgtSMP.show', $user->id_user))->with('success', "Password $user->nama Sudah Berhasil Diganti!");
    }
    ...
    public function printkartu($id)
    {
        ...
        // dd($cek_ortu);
        if ($cek_siswa < 1) {
            return redirect(route('mgtSMP.show', $user->id_user))->with('errors', "Silahkan Lengkapi Biodata Siswa Terlebih Dahulu");
        }
        if ($cek_ortu < 1) {
            return redirect(route('mgtSMP.show', $user->id_user))->with('errors', "Silahkan Lengkapi Data Orang Tua Terlebih Dahulu");
        }
    ...
    public function bayarformulir($id)
    {
        ...
        return redirect(route('mgtSMP.index'))->with('success', 'Data Pembayaran ' . $user->nama . ' sudah berhasil diperbarui! Sekarang ' . $user->nama . ' dapat masuk kedalam sistem untuk melengkapi data.');
    }

    public function laporanSMP()
    {
        return Excel::download(new SMPExport, 'datasmp.xlsx');
    }
}
